/datum/job/roguetown/merchant
	...
	tutorial = "The merchant's guild representative, tasked with maintaining trade relations with the outside world. They are tasked with procuring goods for the manor, and selling them to the townsfolk."
